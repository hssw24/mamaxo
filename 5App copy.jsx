document.addEventListener("DOMContentLoaded", function () {
    ...
    function generateQuestion() {
        ...
        lastNumber = number;
        correctAnswer = number * 5; // Welche Zahlenreihe?
        questionCounts[number] = (questionCounts[number] || 0) + 1;
        question.textContent = `${number} × 5 = ?`; // Rechenaufgabe am Bildschirm
        generateAnswerButtons();
    }
*/
    ...
    function generateAnswerButtons() {
        ...
        let answers = Array.from({ length: 10 }, (_, i) => (i + 1) * 5); // Mögliche Antworten 
